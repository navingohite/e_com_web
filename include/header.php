                                ...
                                <ul class="nav align-items-center">
                                    <li class="language">
                                        ...
                                        <ul class="dropdown-list">
                                            <li><a href="#"><img src="<?=$site?>/assets/img/icon/en.png" alt=""> english</a></li>
                                            <li><a href="#"><img src="<?=$site?>/assets/img/icon/fr.png" alt=""> french</a></li>
                                        </ul>
                                    </li>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-3">
                            <div class="logo">
                                <a href="<?=$site?>/">
                                    <img src="<?=$site?>/assets/img/logo/logo.png" alt="">
                                </a>
                            </div>
                        </div>
                        <!-- start logo area -->
									...
									if(isset($_SESSION['login']))
{
	?>
                                   ...
                                   <li>
                                            <a class="notificationt" href="<?=$site?>/wishlist.php">
	...
	if(isset($_SESSION['login']))
{
	?>
                                        <li class="mini-cart-wrap">
                                            <a class="notificationt" href="<?=$site?>/cart.php">
                        ...
                        <div class="col-lg-9">
                            <div class="main-menu home-main">
                                ...
                                <nav class="desktop-menu">
                                    <ul>
                                        <li class="active"><a href="<?=$site?>">Home <i class="fa fa-home"></i></a>
                                           
                                        </li>
                                       <?php
												$qtq=select("select * from category order by id asc limit 0,4");
...
?>
	...
	?>
										...
										<li><a href="<?=$site?>">Other <i class="fa fa-angle-down"></i></a>
                                            <ul class="dropdown">
                                        <?php
												$qtq=select("select * from category order by id asc limit 4,30");
												while($apa=mysqli_fetch_array($qtq))
												{
													extract($apa);
?>
                        ...
                        <div class="mobile-main-header">
                            <div class="mobile-logo">
                                <a href="<?=$site?>/index.php">
                                    <img src="<?=$site?>/assets/img/logo/logo123.png" alt="Brand Logo">
                                </a>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="category-toggle-wrap">
                            ...
                            <nav class="category-menu">
                                <ul class="categories-list">
                                    <?php
									$qq=select("select * from sub_category ");
												while($aa=mysqli_fetch_array($qq))
												{
													extract($aa);
?>
