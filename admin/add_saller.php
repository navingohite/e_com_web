...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, Sony Ericsson, Motorola web design" />
    ...
    <div class="wrapper">
        ...
        <div id="content">
			...
			<div id="success"></div>
			<h2 class="main-title-w3layouts mb-2 text-center">Add New Saller</h2>
                ...
                <div class="outer-w3-agile mt-3">
                   ...
                   <form id="fupForm" method="post" enctype="multipart/form-data">
						...
						<div class="form-group col-md-6">
                                ...
                                <input type="text"  name="email" class="form-control" id="category_name">
                        </div>
					    </div>
						<div class="form-row">
						<div class="form-group col-md-6">
                                <label for="category_name" id="business_nameerror">Mobile Number</label>
                                <input type="text"  name="mobile" class="form-control" id="category_name">
                        </div>
					    </div>
						<div class="form-row">
						<div class="form-group col-md-6">
                                <label for="category_name" id="business_nameerror">Password</label>
                                <input type="text"  name="password" class="form-control" id="category_name">
                        </div>
					    </div>
								<div class="form-row">
						<div class="form-group col-md-6">
                                <label for="category_name" id="business_nameerror">Profile Image</label>
                                <input type="file"  name="file" class="form-control" id="category_name">
                        </div>
					    </div>
					    <div class="form-row">
						<div class="form-group col-md-6">
                                <label for="category_name" id="business_nameerror">Shop Name</label>
						...
						<div class="form-group col-md-6">
                                ...
                                <input type="text"  name="person_designation" class="form-control" id="person_designation">
                        </div>
					    </div>
