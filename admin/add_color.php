...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, Sony Ericsson, Motorola web design" />
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h2 class="main-title-w3layouts mb-2 text-center">Add Size</h2>
            <section class="forms-section">
                ...
                <div class="outer-w3-agile mt-3">
                    ...
                    {
                        extract($_REQUEST);
                        $n=iud("INSERT INTO `colordata` (`name`) VALUES ('$colorname')");
                        if($n==1)
                        {
                   ...
                   <form id="fupForm" method="post" enctype="multipart/form-data">
						...
						<div class="form-group col-md-6">
                                <label for="category_name" id="business_nameerror">Add Color </label>
                                <input type="type" class="form-control" name="colorname">
							</div>
							</div>
