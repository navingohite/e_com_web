  ...
  if($total_row > 0)
  {
   ...
   if(in_array($url, $data))
   {
    ...
    $url = $url . '-' . $count;
					...
					$i = iud("INSERT INTO `product`(`title`, `p_url`, `category`, `sub_category`, `price`, `cut_price`, `discount`,`description`) VALUES ('$title','$url','$category','$sub_category','$price','$cut_price','$dp','$description')");
					$errors = array();
				$uploadedFiles = array();
