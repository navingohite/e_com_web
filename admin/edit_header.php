...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, Sony Ericsson, Motorola web design" />
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h2 class="main-title-w3layouts mb-2 text-center">Edit Text</h2>
            <section class="forms-section">
                ...
                <div class="outer-w3-agile mt-3">
                   ...
                   <form id="fupForm" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
						<?php 
						$s=select("select * from header where id='".$_REQUEST['id']."'");
						...
						?>
                            <div class="form-group col-md-6">
                                <label for="category_name" id="business_nameerror">Text</label>
                                <input type="text"  name="text" class="form-control"  value="<?=$head_title?>" id="text_title">
                            </div>
                            <?php
						}
                            ?>
...
var valid=true;
var text_title=$.trim($("#text_title").val());
if(valid)
{
