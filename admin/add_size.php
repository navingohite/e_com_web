        ...
        <div id="content">
            ...
            <section class="forms-section">
                ...
                <div class="outer-w3-agile mt-3">
                    ...
                    {
                        extract($_REQUEST);
                        $n=iud("INSERT INTO `sizedata` (`name`) VALUES ('$sizename')");
                        if($n==1)
                        {
                   ...
                   <form id="fupForm" method="post" enctype="multipart/form-data">
						...
						<div class="form-group col-md-6">
                                <label for="category_name" id="business_nameerror">Add Size </label>
                                <input type="type" class="form-control" name="sizename">
							</div>
							</div>
