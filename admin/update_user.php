        ...
        <div id="content">
            ...
            <section class="forms-section">
				...
				<?php
					   ...
					   {
						   extract($_REQUEST);
						   	  $n=iud("update register set name='$name', email='$email',mobile='$mobile', password='$password' where id='".$_REQUEST['id']."'");
	  if($n==1)
	  {
		  ...
		  echo"<div class='alert  alert-danger'>Something Went Wrong </div>";
                ...
                <div class="outer-w3-agile mt-3">
                   ...
                   <form id="fupForm" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
						<?php
						$at=select("select * from register where id='".$_REQUEST['id']."'");
