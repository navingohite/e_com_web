...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, Sony Ericsson, Motorola web design" />
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h2 class="main-title-w3layouts mb-2 text-center">Add Cover Image</h2>
            <section class="forms-section">
                ...
                <div class="outer-w3-agile mt-3">
                    ...
                    {
                        extract($_REQUEST);
                        $covernam=$_FILES['cover']['name'];
                          $tmp_name=$_FILES['cover']['tmp_name'];
                          $yr=rand(1,1000);
                          $covername=$yr.$covernam;
                           move_uploaded_file($tmp_name, "upload/".$covername);
                         $n=iud("INSERT INTO `cover` (`name`) VALUES ('$covername')");
                        if($n==1)
                        {
                   ...
                   <form method="post" enctype="multipart/form-data">
						...
						<div class="form-group col-md-6">
                                <label for="category_name" id="business_nameerror">Add Cover Image </label>
