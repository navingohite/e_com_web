...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, Sony Ericsson, Motorola web design" />
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h2 class="main-title-w3layouts mb-2 text-center">Add SubCategory</h2>
                ...
                <div class="outer-w3-agile mt-3">
                   ...
                   <form id="fupForm" method="post" enctype="multipart/form-data">
						...
						<div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                <label for="category_name" id="business_nameerror">Subcategory Url</label>
                                <input type="text"  name="s_url" class="form-control" id="s_url">
                            </div>
