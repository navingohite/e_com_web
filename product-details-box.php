                    ...
                    <div class="col-12">
                        <div class="breadcrumb-wrap">
                            <nav aria-label="breadcrumb">
                                <h1>product details box slider</h1>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                    <li class="breadcrumb-item"><a href="shop.php">shop</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">product details box slider</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 order-1 order-lg-2">
                        ...
                        <div class="product-details-inner">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="product-details-des box-layout">
