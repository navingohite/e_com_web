...
<span class="counter pull-right"></span>
					...
					<?php
					 $query="SELECT * FROM ((( fund INNER JOIN `business_idea` on fund.business_id=business_idea.id) INNER JOIN interested_people on business_idea.id=interested_people.business_id) INNER JOIN register on interested_people.userid=register.id) WHERE fund.userid=
'".$_SESSION['userid']."'";
					 $r=select($query);
