...
<span class="counter pull-right"></span>
					...
					<?php
					$r=select("SELECT * FROM `product` where AddBy='".$_SESSION['sellerid']."' order by id desc");
                        ...
                        <table class="table table-hover table-bordered results">
							...
							?>
                                <tr>
                                    ...
                                    <td><a href="view_images.php?id=<?=$res[0]?>"><button class="btn btn-warning">View </button></a></td>
									 <td><a href="edit_product.php?id=<?=$res[0]?>"><button class="btn btn-info">Edit </button></a></td>
									<td><a href="delete_product.php?id=<?=$res[0]?>"><button class="btn btn-danger">Delete</button></a></td>
                                </tr>
                              <?php
							  $n++;
							}
